...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    updateUI() {
      var msg,
        t1 = document,
        t2 = t1.querySelector("#day-counter");
      if (t2 != null)
        J.set$text$x(t2, "" + $.day);
      t2 = t1.querySelector("#grape-water");
      if (t2 != null)
        J.set$text$x(t2, "" + $.grapeWater + "%");
      t2 = t1.querySelector("#avocado-water");
      if (t2 != null)
        J.set$text$x(t2, "" + $.avocadoWater + "%");
      t2 = t1.querySelector("#grape-leaves");
      if (t2 != null)
        J.set$text$x(t2, "" + $.grapeLeavesDays);
      msg = t1.querySelector("#message-log");
      if ($.grapeLeavesDays >= 15) {
        if (msg != null)
          J.set$text$x(msg, "\u26a0\ufe0f [\u062a\u0646\u0628\u064a\u0647]: \u0623\u0648\u0631\u0627\u0642 \u0627\u0644\u0639\u0646\u0628 \u062c\u0627\u0647\u0632\u0629 \u0644\u0644\u0642\u0637\u0627\u0641 \u0627\u0644\u0622\u0646!");
      } else if ($.grapeWater < 30) {
        if (msg != null)
          J.set$text$x(msg, "\ud83d\udea8 [\u062a\u062d\u0630\u064a\u0631]: \u0627\u0644\u0639\u0646\u0628 \u0628\u062d\u0627\u062c\u0629 \u0644\u0644\u0631\u064a!");
      } else if ($.avocadoWater < 30) {
        if (msg != null)
          J.set$text$x(msg, "\ud83d\udea8 [\u062a\u062d\u0630\u064a\u0631]: \u0627\u0644\u0623\u0641\u0648\u0643\u0627\u062f\u0648 \u0628\u062d\u0627\u062c\u0629 \u0644\u0644\u0631\u064a!");
      } else if (msg != null)
        J.set$text$x(msg, "");
    },
    main() {
      ...
      A.updateUI();
      t1 = document;
      t2 = t1.querySelector("#btn-water-grape");
      if (t2 != null) {
  ...
  A.main_closure.prototype = {
    call$1(_) {
      ...
      $.grapeWater = B.JSInt_methods.clamp$2($.grapeWater + 30, 0, 100);
      A.updateUI();
    },
    $signature: 1
  };
  A.main_closure0.prototype = {
    call$1(_) {
      type$.MouseEvent._as(_);
      $.avocadoWater = B.JSInt_methods.clamp$2($.avocadoWater + 30, 0, 100);
      A.updateUI();
    },
    $signature: 1
  };
  A.main_closure1.prototype = {
    call$1(_) {
      type$.MouseEvent._as(_);
      $.day = $.day + 1;
      $.grapeWater = B.JSInt_methods.clamp$2($.grapeWater - 10, 0, 100);
      $.avocadoWater = B.JSInt_methods.clamp$2($.avocadoWater - 15, 0, 100);
      $.grapeLeavesDays = $.grapeLeavesDays + 1;
      A.updateUI();
    },
    $signature: 1
  };
  A.main_closure2.prototype = {
    call$1(_) {
      var msg;
      type$.MouseEvent._as(_);
      msg = document.querySelector("#message-log");
      if ($.grapeLeavesDays >= 15) {
        if (msg != null)
          J.set$text$x(msg, "\ud83c\udf89 \u062a\u0645 \u0642\u0637\u0627\u0641 \u0623\u0648\u0631\u0627\u0642 \u0627\u0644\u0639\u0646\u0628 \u0628\u0646\u062c\u0627\u062d!");
        $.grapeLeavesDays = 0;
      } else if (msg != null)
        J.set$text$x(msg, "\u274c \u0627\u0644\u0623\u0648\u0631\u0627\u0642 \u0644\u0645 \u062a\u0643\u062a\u0645\u0644 \u0628\u0639\u062f (\u062a\u062d\u062a\u0627\u062c 15 \u064a\u0648\u0645\u0627\u064b).");
      A.updateUI();
    },
    $signature: 1
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_closure, A.main_closure0, A.main_closure1, A.main_closure2]);
